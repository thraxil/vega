defmodule VegaWeb.Components.Breadcrumbs do
  ...
  def breadcrumb(%{user: _user, type: _type, year: _year, month: _month, day: _day} = assigns) do
    ...
    <li><.link navigate={Routes.page_path(VegaWeb.Endpoint, :user_type_year_month_day_index, @user.username, @type <> "s", @year, @month, @day)}><%= @day %></.link></li>
    """
  end
  ...
  def breadcrumb(%{user: _user, type: _type, year: _year, month: _month} = assigns) do
    ...
    <li><.link navigate={Routes.page_path(VegaWeb.Endpoint, :user_type_year_month_index, @user.username, @type <> "s", @year, @month)}><%= @month %></.link></li>
    """
  end
  ...
  def breadcrumb(%{user: _user, type: _type, year: _year} = assigns) do
    ...
    <li><.link navigate={Routes.page_path(VegaWeb.Endpoint, :user_type_year_index, @user.username, @type <> "s", @year)}><%= @year %></.link></li>
    """
  end
  ...
  def breadcrumb(%{user: _user, type: _type} = assigns) do
    ...
    <li><.link navigate={Routes.page_path(VegaWeb.Endpoint, :user_type_index, @user.username, @type <> "s")}><%= @type <> "s" %></.link></li>
    """
  end
  ...
  def breadcrumb(%{user: _user} = assigns) do
    ...
    <li><.link navigate={Routes.page_path(VegaWeb.Endpoint, :user_detail, @user.username)}><%= @user.username %></.link></li>
    """
  end
end
